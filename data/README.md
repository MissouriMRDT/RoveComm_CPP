...
The **Data** directory is intended to store data files and resources used in the RoveComm C++ project. This directory focuses on organizing and managing various types of data that are essential for the project's functionality, analysis, or training.
...
1. **Configuration files**: Files containing configuration data or settings used by different components or modules of the RoveComm C++ project, such as calibration parameters, control parameters, network protocols, or environment specifications.
2. **Log files**: Files or directories containing log data captured during the execution or operation of the RoveComm C++ project, providing valuable information for debugging, analysis, or performance evaluation.
